...
export class AddProductsMigration1714384016895 implements MigrationInterface {
    ...
    for (const productData of products) {
      const category = await entityManager.findOne(Category, { where: { name: productData.category } });
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
      ...
      // Delete the records inserted in the 'up' method
